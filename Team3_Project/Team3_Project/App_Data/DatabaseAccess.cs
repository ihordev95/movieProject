...
public class DatabaseAccess {
	private readonly System.String conn = "server=memdixyp.mysql.db.hostpoint.ch;uid=memdixyp_user;pwd=rmpvzSp4BsNm;database=memdixyp_imdb;SslMode=None"; //read only
	private readonly System.String conn2 = "server=memdixyp.mysql.db.hostpoint.ch;uid=memdixyp_user;pwd=rmpvzSp4BsNm;database=memdixyp_film;SslMode=None"; //writable
