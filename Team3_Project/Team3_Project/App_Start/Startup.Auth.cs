...
namespace Team3_Project {
	public partial class Startup {
		...
		public void ConfigureAuth(Owin.IAppBuilder app) {
			...
			app.CreatePerOwinContext(Team3_Project.Models.ApplicationDbContext.Create);
			...
			app.UseCookieAuthentication(new Microsoft.Owin.Security.Cookies.CookieAuthenticationOptions {
				...
				Provider = new Microsoft.Owin.Security.Cookies.CookieAuthenticationProvider {
					...
					OnValidateIdentity = Microsoft.AspNet.Identity.Owin.SecurityStampValidator.OnValidateIdentity<ApplicationUserManager , Team3_Project.Models.ApplicationUser>(
